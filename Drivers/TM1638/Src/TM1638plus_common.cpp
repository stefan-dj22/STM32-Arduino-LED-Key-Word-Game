...
*/
TM1638plus_common::TM1638plus_common(TM_GPIO_PinConfig_t STB_gpio, TM_GPIO_PinConfig_t CLK_gpio, TM_GPIO_PinConfig_t DIO_gpio)
		: _STROBE_IO(STB_gpio), _CLOCK_IO(CLK_gpio),_DATA_IO(DIO_gpio) {
	// Blank constructor
}
