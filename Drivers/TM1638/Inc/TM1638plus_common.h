...
public:
	TM1638plus_common();
	TM1638plus_common(TM_GPIO_PinConfig_t STB_gpio, TM_GPIO_PinConfig_t CLK_gpio, TM_GPIO_PinConfig_t DIO_gpio);
	void displayBegin();	 
	void reset(void);  
...
protected:
	...
	TM_GPIO_PinConfig_t _STROBE_IO; /**<  GPIO connected to STB on Tm1638  */
	TM_GPIO_PinConfig_t _DATA_IO;    /**<  GPIO connected to DIO on Tm1638  */
	TM_GPIO_PinConfig_t _CLOCK_IO; /**<  GPIO connected to CLk on Tm1638  */
